...
(function (global, factory) {
  ...
  function isFontInstalled(fontName) {
    ...
    return (
      originalWidth !== width &&
      $$1.inArray(fontName.toLowerCase(), supportedFonts) > -1
    );
  }
  ...
  var WrappedRange = /** @class */ (function () {
     ...
     * @return {Node}
     */
    WrappedRange.prototype.insertNode = function (
      node,
      applyPrevStyle = false
    ) {
      var rng = this.wrapBodyInlineWithPara().deleteContents();
      var info = dom.splitPoint(rng.getStartPoint(), dom.isInline(node));
      if (info.rightNode) {
        if (applyPrevStyle && info.rightNode.nodeType === 1) {
          var sameStyleNode = info.rightNode.cloneNode();
          sameStyleNode.innerHTML = "";
          sameStyleNode.appendChild(node);
          if (sameStyleNode.innerHTML === "") {
        ...
        if (applyPrevStyle) {
          var chkNode = info.container.lastChild;
          if (chkNode && chkNode.nodeType === 1) {
            var sameStyleNode = chkNode.cloneNode();
            sameStyleNode.innerHTML = "";
            sameStyleNode.appendChild(node);
            if (sameStyleNode.innerHTML === "") {
              info.container.appendChild(node);
            } else {
              info.container.appendChild(sameStyleNode);
            }
          } else {
            info.container.appendChild(node);
          }
  ...
  var Editor = /** @class */ (function () {
    ...
    Editor.prototype.insertImagesOrCallback = function (files) {
      ...
      if (callbacks.onImageUpload) {
        _this.context.triggerEvent("image.upload", files);
  ...
  var Buttons = /** @class */ (function () {
    ...
    Buttons.prototype.updateCurrentStyle = function ($container) {
      ...
      if (styleInfo["font-family"]) {
        ...
        fontName_1 = fontName_1 == null ? _this.options.fontName : fontName_1;
  ...
  var ImageDialog = /** @class */ (function () {
    ...
    ImageDialog.prototype.initialize = function () {
      ...
      var body = [
        ...
        imageLimitation,
        "</div>",
        '<div class="form-group note-group-image-url" style="display:none; overflow:auto;">',
